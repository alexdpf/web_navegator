...
let currentPage = `www.defaultpage.com.au`;
// ------------------------------
// Helper Functions
// ------------------------------
...
while (finish === false) {
  ...
  console.log('Sorry, BackPage is not available,stack is empty.')
  } else if (lowerCaseAnswer === 'n') { 
  console.log('Sorry, NextPage is not available,stack is empty.')
